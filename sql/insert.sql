...
INSERT INTO users (name, username, password, completedSentences, completedVerifications) VALUES ('Jón Jónsson', 'jonjons', '$2a$11$pgj3.zySyFOvIQEpD7W6Aund1Tw.BFarXxgLJxLbrzIv/4Nteisii', 22, 5);
INSERT INTO users (name, username, password, completedSentences, completedVerifications) VALUES ('Guðrún Guðrúnar', 'gunnagunn', '$2a$11$pgj3.zySyFOvIQEpD7W6Aund1Tw.BFarXxgLJxLbrzIv/4Nteisii', 13, 12);
...
INSERT INTO simplifiedSentences (userId, sentenceId, simplifiedSentence, verified) VALUES (2, 1, 'Þótt að veðrið sé óvissara þennan áratug, verður ennþá þörf fyrir samfélög að minnka neikvæð áhrif loftslagsbreytinga.', true);
